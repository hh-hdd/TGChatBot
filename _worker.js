...
export default {
  async fetch(request, env) {
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/hh-hdd/TGChatBot/tree/master/CFTeleTrans/start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/hh-hdd/TGChatBot/tree/master/CFTeleTrans/notification.md');
